        ...
        <div className="animate-fade-in-up">
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-400 mt-2 max-w-2xl mx-auto">The Fæmily Plan includes everything in Essæntial for up to 6 members, plus these exclusive features:</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <FeatureCard 
                        ...
                        description="Bring up to 6 family members into your private space. Assign roles and permissions to manage who can add, edit, and view your shared history."
                    />
                    <FeatureCard 
                        icon={Sparkles}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-20 items-center">
                    <div className="text-left">
                        ...
                        <div className="flex items-center -space-x-3 mb-4">
                            ...
                            <div className="w-12 h-12 rounded-full bg-slate-600 ring-4 ring-slate-900 flex items-center justify-center text-slate-300 text-xl font-light">+3</div>
                        </div>
