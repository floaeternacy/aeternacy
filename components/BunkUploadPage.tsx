...
import { ArrowLeft, UploadCloud, Sparkles, FolderCheck, CheckCircle } from 'lucide-react';
...
const BulkUploadPage: React.FC<BulkUploadPageProps> = ({ onNavigate, userTier, triggerConfirmation }) => {
    ...
    // Fixed: Use the correct 'lægacy' UserTier literal instead of 'legacy'
    const isLegacyUser = userTier === 'lægacy';

    // Fix: Corrected property name from BULK_UPLOAD_PER_1000 to BULK_UPLOAD_BASE_PER_1000
    const calculatedCost = Math.ceil(photoCount / 1000) * TOKEN_COSTS.BULK_UPLOAD_BASE_PER_1000;

    const handleUpload = async () => {
        // Mock upload action
        await new Promise(resolve => setTimeout(resolve, 1000));
        alert(`Starting upload and analysis of ${photoCount.toLocaleString()} photos...`);
        console.log(`TELEMETRY: token_spend_ok, feature: BULK_UPLOAD, cost: ${isLegacyUser ? 0 : calculatedCost}`);
    };
    
    const handleTriggerUpload = () => {
        if (isLegacyUser) {
            // Legacy users might have free credits, for now we assume they pay too or have a balance
    ...
    const renderCTA = () => {
        if (isLegacyUser) {
            return (
                <div className="container mx-auto px-6 text-center max-w-2xl">
                    <h2 className="text-4xl font-bold font-brand text-white">Your Upload Credits</h2>
        ...
        return (
            <div className="container mx-auto px-6 text-center max-w-2xl">
                <h2 className="text-4xl font-bold font-brand text-white">Ready to Organize Your Memories?</h2>
                <p className="text-slate-300 mt-4">
                    Estimate the number of photos you want to upload. Cost is {TOKEN_COSTS.BULK_UPLOAD_BASE_PER_1000} Tokæn per 1,000 photos.
                </p>
    ...
    return (
        <div className="bg-slate-900 text-white animate-fade-in-up -mt-20">
            ...
            <section className="relative h-[70vh] flex items-center justify-center text-center overflow-hidden -mt-20">
                ...
                <h1 className="text-5xl md:text-7xl font-bold font-brand text-white" style={{ textShadow: '0 2px 20px rgba(0,0,0,0.7)' }}>Neural Organization.</h1>
                <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mt-4 mb-8" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.7)' }}>
                    Upload your entire photo archive and let æterny analyze, declutter, and curate your story for you.
                </p>
            ...
            <section id="main-content" className="py-20 md:py-32 bg-slate-900">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold font-brand text-white">Automated Masterpiece</h2>
                    ...
                    <div className="space-y-12">
                        ...
                        <Step 
                            ...
                            description="æterny gets to work, automatically detecting and removing screenshots, receipts, and duplicates. It groups similar photos and intelligently suggests the best shots."
                        />
                        <Step 
                            icon={FolderCheck}
