      ...
      .then(audioBuffer => {
        ...
        source.onended = () => {
          if (audioSourceRef.current === source) {
            setIsNarrating(false);
            audioSourceRef.current = null;
            autoAdvanceTimerRef.current = window.setTimeout(advanceToNext, 3000); 
          }
        };
      })
      .catch(err => {
  ...
  if (!currentMoment) {
    return (
        <div className="fixed inset-0 bg-black flex flex-col items-center justify-center text-white">
            <p>No playable moments in your chronicle.</p>
  ...
  return (
    <div className="fixed inset-0 bg-black text-white theater-container">
      ...
      <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
        <h2 className="text-xl font-brand">The Chronicle: Review</h2>
