...
import { BrainCircuit, Scan, Sparkles, ArrowLeft } from 'lucide-react';

interface VRLabPageProps {
  onNavigate: (page: Page) => void;
}

const VRLabPage: React.FC<VRLabPageProps> = ({ onNavigate }) => {
    return (
        <div className="bg-slate-900 text-white animate-fade-in-up -mt-20">
            ...
            <section className="relative h-screen -mt-20 flex items-center justify-center text-center overflow-hidden pt-20">
                ...
                <div className="relative z-10 p-6">
                    <h1 className="text-4xl md:text-6xl font-bold font-brand text-white" style={{ textShadow: '0 2px 20px rgba(0,0,0,0.7)' }}>The VR Lab</h1>
                ...
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-slate-400 text-sm">Step into your VR memory with VR/AR devices. Walk through your childhood home, or have a conversation with a loved one's Living Avatar.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-32 bg-slate-900">
                <div className="container mx-auto px-6 text-center max-w-2xl">
                    ...
                    <p className="text-slate-300 mt-4">The VR Lab represents the pinnacle of personal preservation. This is a high-touch, bespoke service available exclusively for our Lægacy members, requiring a personal consultation to begin the delicate process of digital immortalization.</p>
