...
import { ArrowLeft, BookOpen, FilePenLine, BookImage, CheckCircle, ExternalLink, UploadCloud, BrainCircuit } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2 lg:col-span-4">
             <FeatureCard
                icon={BrainCircuit}
                title="VR Lab"
                description="The pinnacle of personal preservation. Go beyond remembering — step back in time and relive your most cherished moments in hyper-realistic VR & AR through a high-touch, bespoke service."
